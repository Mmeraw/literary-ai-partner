      ...
      recommendations: [
        {
          ...
          candidate_text_a: "The river crawled through the valley, barely moving.",
          candidate_text_b: "Barely moving, the river inched its way through the narrow valley.",
          candidate_text_c: "The valley held the river still, its current a whisper against stone.",
        },
      ],
    })),
    overall: {
