 ...
 * LLM-extracted surfaces (premise, trigger warnings) are extracted when a
 * synthesis output is available from the pipeline.
 */
 ...
 *
 * Premise and trigger warnings must be provided externally (from LLM extraction)
 * since they require semantic understanding of the manuscript content.
 */
