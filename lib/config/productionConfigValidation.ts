...
const WORKER_LEASE_MS_DEFAULT = 600_000;
const WORKER_LEASE_MS_MIN = 30_000;
const WORKER_LEASE_MS_MAX = 1_200_000;
...
export function validateProductionConfig(
  ...
  const workerMaxExecutionMs = parseIntEnv(env, "EVAL_WORKER_MAX_EXECUTION_MS", 110_000);
