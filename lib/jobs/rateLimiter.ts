 ...
 * 
 * Security: This check assumes userId is derived from real authentication in production.
 * Header-based fallbacks, if any, should be handled at the API boundary in non-production only.
 */
