...
export const REVISE_PROCESS_REGISTRY: readonly ReviseStage[] = [
  {
    ...
    outputMetrics: ['opportunity count is evidence-driven and may be zero', 'no Ready opportunity without evidence_anchor or manuscript_wide_support', 'all criteria traceable'],
