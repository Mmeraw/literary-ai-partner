...
const REVISE_PROCESS_REGISTRY_SOURCE: readonly ReviseStageSource[] = [
  {
    ...
    outputRequiredFields: ['quality_manifest', 'dcip_compliance', 'constitutional_authority_registry', 'opportunity_id', 'finding_id', 'criterion', 'severity', 'evidence_anchor', 'revision_operation', 'readiness'],
