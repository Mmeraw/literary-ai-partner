...
const REVISE_PROCESS_REGISTRY_SOURCE: readonly ReviseStageSource[] = [
  {
    ...
    inputRequiredFields: ['criteria', 'confirmed_mode', 'enrichment', 'overview', 'dcip_compliance', 'canonicalOpportunityLedger.opportunities', 'canonicalOpportunityLedger.recommendation_dispositions'],
    inputMetrics: ['evaluation_result_v2 present', 'author_exposure_certification_v1 dcip_compliance passes', 'required constitutional authorities loaded', 'no blocking audit verdicts', 'recommendation lineage coverage = 100%', 'admitted disposition canonical identity coverage = 100%', 'canonical authority present even when opportunity count = 0'],
