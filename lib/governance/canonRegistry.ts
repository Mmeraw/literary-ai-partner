...
const CANON_REGISTRY_INTERNAL: MutableCanonRegistry = new Map([
  ...
  [
    ...
    },
    {
      ...
      title: 'Volume III — Pipeline API JSON Schema',
      path: 'canon/volumes/VOLUME-III-PIPELINE-API-JSON-SCHEMA.md',
      status: 'ACTIVE',
      sourceDocument: 'Pipeline API JSON Schema for Evaluation Pipeline',
      destination: 'evaluation pipeline, API contracts',
      addedAt: '2026-04-10',
    },
    {
      canonId: 'VOL-III-FINAL-PIPELINE-DIAGRAM',
      title: 'Volume III — Final Pipeline Diagram + State Model',
      path: 'canon/volumes/VOLUME-III-FINAL-PIPELINE-DIAGRAM-STATE-MODEL.md',
      status: 'ACTIVE',
      sourceDocument: 'Final Pipeline Diagram and State Model',
      destination: 'evaluation pipeline, state management',
      addedAt: '2026-04-10',
    },
    {
      canonId: 'VOL-III-EVAL-PIPELINE-PASS-SYSTEM',
      title: 'Volume III — Evaluation Pipeline Architecture (Pass System)',
      path: 'canon/volumes/VOLUME-III-EVALUATION-PIPELINE-PASS-SYSTEM.md',
      status: 'ACTIVE',
      sourceDocument: 'Evaluation Pipeline Architecture Pass System',
      destination: 'evaluation pipeline, pass architecture',
      addedAt: '2026-04-10',
    },
    {
      canonId: 'VOL-II-A-PR-PROMPT-RUNTIME',
      title: 'Volume II-A-PR — Prompt Runtime Binding Spec',
      path: 'canon/volumes/VOLUME-II-A-PR-PROMPT-RUNTIME-BINDING-SPEC.md',
      status: 'ACTIVE',
      sourceDocument: 'Prompt Runtime Binding Spec (Engineering Grade)',
      destination: 'prompt engineering, runtime binding',
      addedAt: '2026-04-10',
    },
    {
      canonId: 'RG-EVAL-RUNTIME-GOVERNANCE',
      title: 'RevisionGrade Evaluation & Runtime Governance v1.0.0',
      path: 'canon/volumes/REVISIONGRADE-EVALUATION-RUNTIME-GOVERNANCE.md',
      status: 'ACTIVE',
      sourceDocument: 'RevisionGrade Evaluation and Runtime Governance Carry-Forward Canon',
      destination: 'governance, runtime enforcement',
      addedAt: '2026-04-10',
    },
  ],
]);
