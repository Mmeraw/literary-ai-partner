...
export const STORYGATE_PROCESS_REGISTRY: readonly StorygateProcessEntry[] = [
  ...
  },
  {
    ...
    codeSurfaces: ['docs/storygate/STORYGATE_STUDIO_CANON.md', 'app/storygate-studio/apply/page.tsx'],
    ...
    notes: 'Centralized current-canon validator is required; Base44 validators are legacy-only and cannot certify current Storygate scope.',
  },
  {
    sequence: 3,
...
export const STORYGATE_CERTIFICATION_GATE_REGISTRY: readonly StorygateCertificationGateEntry[] = [
  ...
  { gateId: 'SGCG02_REQUIRED_PACKAGE', description: 'Package requires query letter, synopsis, author bio, elevator pitch, agent pitch, market comparables, market category, target audience, market position statement, sample pages, and rights declaration.', appliesToStageId: 'SG05_PACKAGE_VERIFICATION', enforced: false, testEvidence: '__tests__/lib/storygate/storygateRegistry.test.ts', notes: 'Registry locks package contract; runtime validator remains missing.' },
