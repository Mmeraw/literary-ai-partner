...
-- Date: 2026-02-07
-- Purpose: avoid ambiguity between canonical and compat overloads when using named parameters
-- Strategy: keep compat signature by type order (integer, timestamptz, text)
--           but rename parameters so named-arg calls resolve only to canonical
