...
export const metadata = {
  title: "Founder Case Study: Cartel Babies | RevisionGrade",
  description:
    "Evaluation-report-only founder case study for Cartel Babies, an upmarket suspense manuscript evaluated through RevisionGrade.",
};

export default function CartelBabiesCaseStudyPage() {
  return (
    <SeoProofPage
      eyebrow="Founder evaluation case study"
      title="Founder Evaluation Case Study: Cartel Babies."
      subtitle="A report-only case-study page for showing how RevisionGrade diagnoses a real long-form upmarket suspense manuscript without publishing the manuscript itself."
      urlPath="/founder-case-study-cartel-babies"
      primaryCta={{ label: "Back to AI Novel Critique", href: "/ai-novel-critique" }}
      secondaryCta={{ label: "Begin Evaluation", href: "/evaluate" }}
      notice="This case study is for the RevisionGrade evaluation report only. The Cartel Babies manuscript, full chapters, ending spoilers, and extended copyrighted text are not published on this page."
      pdfFilename="revisiongrade-founder-case-study-cartel-babies.pdf"
      blocks={[
        {
          title: "Manuscript context",
          copy: "Cartel Babies is treated as a founder manuscript case study, not as a public novel upload. The page exists to show evaluation behavior after the report quality is ready.",
          bullets: ["upmarket suspense", "long-form manuscript", "founder case study", "evaluation report only"],
        },
        {
      ...
      faqs={[
        {
          q: "Is the Cartel Babies manuscript published here?",
