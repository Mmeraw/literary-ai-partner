  ...
  return (
    <main className="min-h-[calc(100vh-72px)] bg-[#0D0A05] px-4 py-16 text-[#F5EFE4] md:px-6 md:py-24">
      ...
      >
        ...
        >
          Preparing your Revise Workbench…
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#CBBDA4]">
          RevisionGrade is building your revision queue and rendering the manuscript evidence,
          recommendations, and rewrite choices from this evaluation.
        </p>
        <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-[#A9987D]">
          This can take 1–2 minutes. Keep this page open; the workbench will appear automatically
