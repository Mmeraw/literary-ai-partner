...
const C = {
  ...
  borderAsh: "rgba(182,173,160,0.28)",
} as const;
  ...
  return (
    ...
    >
      <section className="pt-24 pb-20 px-6 max-w-6xl mx-auto">
        <p className="text-sm tracking-[0.18em] uppercase font-mono mb-5" style={{ color: C.gold }}>
        ...
        <p className="text-lg leading-relaxed mb-12 max-w-4xl" style={{ color: C.ash }}>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          {/* Sign in panel */}
          <div className="p-10" style={{ backgroundColor: C.panel, border: `1px solid ${C.border}` }}>
            <p className="text-sm tracking-[0.13em] uppercase font-mono mb-8" style={{ color: C.gold }}>
              Existing Account
            </p>
            <Link
              href="/storygate-studio/industry/dashboard"
              className="inline-block w-full text-center px-6 py-4 text-sm tracking-[0.12em] uppercase font-mono transition-opacity hover:opacity-80"
            ...
            <p className="mt-5 text-center">
              <Link
                ...
                className="text-sm font-mono tracking-[0.08em] transition-opacity hover:opacity-70"
                style={{ color: C.ash }}
              >
                Forgot password?
              </Link>
          ...
          <div className="p-10" style={{ border: `1px solid ${C.borderAsh}` }}>
            <p className="text-sm tracking-[0.13em] uppercase font-mono mb-4" style={{ color: C.gold }}>
              New to Storygate Studio
            </p>
            <p className="text-lg leading-relaxed mb-7" style={{ color: C.ash }}>
            ...
            <p className="text-base mb-7 px-4 py-3" style={{ backgroundColor: C.bg, border: `1px solid ${C.borderAsh}`, color: C.ash }}>
            ...
            <button
              disabled
              className="inline-block w-full text-center px-6 py-4 text-sm tracking-[0.12em] uppercase font-mono opacity-40 cursor-not-allowed"
              style={{ backgroundColor: "transparent", color: C.gold, border: `1px solid ${C.gold}` }}
            >
              Request Industry Access—Opening Soon
            </button>
            <p className="mt-5 text-sm text-center" style={{ color: C.ash }}>
        ...
        {/* Trust line */}
        <p
          className="mt-12 text-base text-center leading-relaxed max-w-5xl mx-auto"
