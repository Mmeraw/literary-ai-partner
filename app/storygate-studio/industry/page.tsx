...
export default function IndustryGate() {
  return (
    ...
    >
      <section className="pt-16 pb-12 px-6 max-w-3xl mx-auto">
        ...
        <div className="p-8 mb-6" style={{ backgroundColor: C.panel, border: `1px solid ${C.border}` }}>
          <p className="text-sm tracking-[0.16em] uppercase font-mono mb-6" style={{ color: C.gold }}>
            Existing Account
          </p>
          <Link
            href="/storygate-studio/industry/dashboard"
            className="inline-block w-full text-center px-6 py-4 text-sm tracking-[0.18em] uppercase font-mono transition-opacity hover:opacity-80"
          ...
          <p className="mt-4 text-center">
            <Link
              ...
              className="text-sm font-mono tracking-[0.12em] transition-opacity hover:opacity-70"
              style={{ color: C.ash }}
            >
              Forgot password?
            </Link>
        ...
        <div className="p-8" style={{ border: `1px solid ${C.borderAsh}` }}>
          ...
          <button
            disabled
            className="inline-block w-full text-center px-6 py-4 text-sm tracking-[0.18em] uppercase font-mono opacity-40 cursor-not-allowed"
