  ...
  return (
    <div className="bg-rg-ink text-rg-cream">
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-rg-cream2/80">For author questions, investor conversations, or product feedback, use the signed-in workflow or contact the team directly.</p>
        <div className="mt-10 border border-rg-cream2/12 bg-rg-ink2/60 p-8">
          <h2 className="font-rg-serif text-3xl">Get started</h2>
          <p className="mt-4 leading-7 text-rg-cream2/75">Sign in and open Evaluate to begin. For product context, start with Resources, Reliability, and Methodology.</p>
