  ...
  return (
    <main className="fixed inset-x-0 bottom-0 top-[72px] z-10 overflow-hidden bg-[#0D0A05] px-4 pb-5 pt-3 text-[#F5EFE4]">
      <div className="mx-auto flex h-full max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-xl border border-[#2E261A] bg-[#151008] shadow-2xl">
        <header className="flex min-h-[3rem] shrink-0 items-center justify-between border-b border-[#2E261A] bg-[#151008] px-4">
          <div className="min-w-0"><p className="text-[10px] uppercase tracking-[0.2em] text-[#C8A96E]">Revision Cockpit · surgical repair queue</p><h1 className="truncate text-sm font-semibold leading-6">{payload.manuscriptTitle}</h1></div>
        ...
        <section className="grid min-h-0 flex-1 overflow-hidden xl:grid-cols-[310px_minmax(0,1fr)]">
          ...
          <section className="flex min-w-0 flex-col overflow-hidden bg-[#1C160E]">
            {active && <>
              <div className="shrink-0 border-b border-[#2E261A] px-3 py-1.5">
                <p className="text-[10px] uppercase tracking-[0.18em] text-[#C8A96E]">Diagnosis & Guardrails</p>
                <div className="mt-1 flex flex-wrap items-center gap-1.5"><span className={`shrink-0 rounded px-2 py-0.5 text-[10px] uppercase ${severityClass(active.severity)}`}>{active.severity}</span><span className="shrink-0 rounded border border-[#5A4B33] px-2 py-0.5 text-[10px] uppercase tracking-wider">{criterionOf(active)}</span><span className="shrink-0 rounded border border-[#5A4B33] px-2 py-0.5 text-[10px] uppercase tracking-wider">{active.scope}</span><span className="shrink-0 rounded border border-[#5A4B33] px-2 py-0.5 text-[10px] uppercase tracking-wider">{operationLabels[effectiveOperation(active)] ?? "Revision"}</span></div>
              </div>
              <div className="shrink-0 border-b border-[#2E261A] px-3 py-2"><h2 className="text-base font-semibold leading-6">{active.title}</h2></div>
