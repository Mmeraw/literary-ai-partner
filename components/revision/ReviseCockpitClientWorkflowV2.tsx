...
// Presentation-only pass. This wrapper NEVER alters author or editorial
// content — it only adjusts layout, styling, and visibility of internal UI
// chrome around the V1 workbench. Text content, ledger request bodies, and the
// clipboard are left untouched; punctuation/CMOS normalization happens
// server-side (lib/evaluation/cmosSanitizer.ts) before certification.
