...
function makeCriterion(key: (typeof CRITERIA_KEYS)[number], overrides: Partial<SynthesizedCriterion> = {}): SynthesizedCriterion {
  return {
    ...
    recommendations: [
      {
        priority: "medium",
        action: `After Elena confronts Marcus near the bridge scene, tighten the ${key} dimension by cutting the redundant exposition and replacing it with a concrete decision beat.`,
        expected_impact: "The reader experiences Elena's choice in real-time rather than receiving it as narration, because the gap between dialogue and consequence currently stalls momentum.",
        anchor_snippet: '"she whispered something he could not quite hear"',
        source_pass: 1,
        issue_family: "scene_structure",
        strategic_lever: "scene_goal_clarity",
        revision_granularity: "scene",
        mechanism: "Because the exposition separates the confrontation from its consequence, the reader loses the causal thread.",
        specific_fix: "Cut paragraphs 4–6 of the bridge scene and insert a beat where Elena turns away, forcing Marcus to choose whether to follow.",
        reader_effect: "The reader feels the weight of Marcus's hesitation instead of being told about it.",
        symptom: "Near the bridge passage, three paragraphs of backstory separate Elena's challenge from Marcus's response.",
      },
    ],
    ...overrides,
  };
