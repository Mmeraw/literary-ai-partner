...
describe("prompt pack governance specs", () => {
  ...
  it("Pass 3 includes agreement/divergence/arbitration sections and forbids silent merge", () => {
    ...
    expect(PASS3_SYSTEM_PROMPT.length).toBeLessThanOrEqual(38000);  // P3 (~700) + P4 (~1100) + P5 (~1500) + P6 (~1500) + abstract-criteria grounding (~300) + anchor CANNOT rules (~300) + OUTPUT QUALITY STANDARD (~600) + leverage-first priority (~1200) + manuscript-specific recs (~700) + evidence depth (~500)
