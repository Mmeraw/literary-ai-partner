...
Designed for structurally complex manuscripts with multiple eras, ontological planes, doctrine systems, voice regimes, or canon-bearing paratext. This template extends the global RevisionGrade long-form evaluation and should be used when a standard linear assessment would erase the work's intended architecture.
...
3. Audits canon, doctrine, relic, or symbolic systems for continuity and payoff.
...
`<1 short paragraph naming the manuscript’s governing ambition, the primary emotional anchor, the most significant architectural strength, the most consequential drag, and current readiness.>`

## Structural stack

### Layer & Voice Map

| Layer | Era / Plane | Dominant voice / mode | Function in book | Primary stakes | Major dependencies |
|---|---|---|---|---|---|
| `<...>` | `<...>` | `<...>` | `<...>` | `<...>` | `<...>` |
| `<...>` | `<...>` | `<...>` | `<...>` | `<...>` | `<...>` |
...
|---|---:|---|---|
| Concept & Core Premise | `<x/10>` | `<level>` | `<...>` |
| Narrative Drive & Momentum | `<x/10>` | `<level>` | `<...>` |
| Character Depth & Psychology | `<x/10>` | `<level>` | `<...>` |
| POV, Voice & Tone | `<x/10>` | `<level>` | `<...>` |
| Scene Construction & Function | `<x/10>` | `<level>` | `<...>` |
| Dialogue & Subtext | `<x/10>` | `<level>` | `<...>` |
| Theme / Intelligence | `<x/10>` | `<level>` | `<...>` |
| World-Building & Logic | `<x/10>` | `<level>` | `<...>` |
| Prose / Line-Level Craft | `<x/10>` | `<level>` | `<...>` |
| Pacing & Structural Balance | `<x/10>` | `<level>` | `<...>` |
| Narrative Closure & Promises | `<x/10>` | `<level>` | `<...>` |
| Professional Readiness / Market | `<x/10>` | `<level>` | `<...>` |
| Layer & Mode Integration | `<x/10>` | `<level>` | `<...>` |
| Layer Coherence | `<x/10>` | `<level>` | `<...>` |
| Doctrine / Glyph System Integrity | `<x/10>` | `<level>` | `<...>` |
| Canon & Continuity Integrity | `<x/10>` | `<level>` | `<...>` |
...
`<What this layer is doing narratively, emotionally, philosophically, or canonically.>`
...
Identify repeated objects, vows, motifs, wounds, relics, phrases, gestures, or law structures that allow one layer to illuminate another.
...
Use this section when the work contains scripture, glyph systems, relic catalogs, canon appendix material, or explicit metaphysical law.

### System inventory

| System element | Role | First major appearance | Later obligations | Status |
|---|---|---|---|---|
| `<relic / glyph / law / scripture>` | `<...>` | `<...>` | `<...>` | `<stable / drifting / underused / contradictory>` |
| `<...>` | `<...>` | `<...>` | `<...>` | `<...>` |
