...
Evidence: where in the submitted text the issue appears.
...
Dialogue balance is measured only within the submitted text. Excerpts, chapters, and partial manuscripts may not reflect the dialogue balance of the complete work. Genre expectations vary: literary fiction often trends lower, while thrillers, romance, and commercial fiction often trend higher.
