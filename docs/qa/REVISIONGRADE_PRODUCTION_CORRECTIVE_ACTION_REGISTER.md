...
| RCA-002 | Explain all recommendation dispositions without converting lineage into queue quota | Forensic investigation | Observed production + CI verification | Strong observation; editorial diagnosis pending | Editorial governance | Characterizing | Trace each authoritative source recommendation through identity, materiality/actionability, disposition, optional opportunity identity, persistence, certification, and Revise consumption | Missing, duplicate, unknown-version, orphan admitted, or unauthorized Held disposition blocks certification; suppressed/informational lineage remains non-queue authority | Governed disposition v1; stable source identity; current ledger validator | Representative calibration set records one disposition per material source recommendation, governing rule and evidence; zero silent loss; no score/count admission predicate; no synthetic Held promotion | Criminality V2 production evidence; PR #1354; PR #1358 pending |
