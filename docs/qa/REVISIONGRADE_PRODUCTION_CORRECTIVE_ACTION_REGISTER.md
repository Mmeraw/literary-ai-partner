...
| RCA-005 | Determine whether zero actionable opportunities on strong-but-imperfect evaluations is governed suppression or editorial loss | Forensic investigation | Observed production + CI verification + static contract | Moderate for historical propagation; insufficient for current editorial calibration | Editorial governance | Characterizing | Stratified post-#1362 evaluation calibration; per-criterion lineage review; blind editorial adjudication | Unsafe or ungrounded recommendations remain suppressed; investigation cannot promote work solely to satisfy a count or score expectation | RCA-002 lineage evidence; representative manuscript corpus; adjudication rubric; PR #1362 propagation fix; PG-06B analyzer from REL-E007 | Split the historical PG-06 question into (A) malformed disposition propagation, advanced by REL-E005 and triaged by REL-E007, and (B) valid editorial calibration, still open. At least 30 consented/redacted post-#1362 evaluations across score bands, genre strata, and short-/long-form length classes must include zero-card, low-card, and normal-card outcomes and classify each reviewed case as correct governed suppression, genuine editorial omission, unsupported recommendation pressure, grounding failure, status/cardinality defect, ownership loss, canonicalization loss, or unsupported threshold hypothesis. Correction follows only proven defects. | Criminality V2; historical 82/100 zero-card run; PR #1362 / REL-E005; PR #1365 / REL-E007 |
