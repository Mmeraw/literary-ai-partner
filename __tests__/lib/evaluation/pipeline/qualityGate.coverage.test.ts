    ...
    recommendations: [
      {
        ...
        source_pass: 3,
        mechanism: "the ecological revelation arrives without prior priming, weakening its impact",
        specific_fix: "seed an earlier water anomaly in the opening two hundred words",
        reader_effect: "readers primed for eco-horror pay-off through the speculative thread",
      },
    ],
    ...overrides,
  };
