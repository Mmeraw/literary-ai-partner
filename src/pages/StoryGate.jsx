    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: '#0E0E0E' }}>
            ...
            <div className="max-w-6xl mx-auto px-6 py-16">
                <h2 className="text-3xl font-semibold mb-8" style={{ color: '#F2EFEA' }}>How Storygate Studio Works</h2>
                        ...
                        <Card key={idx} style={{ borderColor: '#A98E4A', backgroundColor: 'rgba(14, 14, 14, 0.8)' }}>
                            <CardContent className="p-6">
                                <div className="flex items-start gap-4">
                                    <div className="p-2 rounded-lg" style={{ backgroundColor: 'rgba(169, 142, 74, 0.3)' }}>
                                        <item.icon className="w-6 h-6" style={{ color: '#D4AF6A' }} />
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold mb-2" style={{ color: '#FFFFFF' }}>{item.title}</h3>
                                        <p className="leading-relaxed" style={{ color: '#E5E5E5' }}>{item.description}</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
            ...
            <div className="py-16" style={{ backgroundColor: 'rgba(14, 14, 14, 0.8)' }}>
                <div className="max-w-6xl mx-auto px-6">
                    <h2 className="text-3xl font-semibold mb-6" style={{ color: '#F2EFEA' }}>What You'll See Inside</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-6">
                        {[
                            ...
                            <div key={idx} className="flex items-start gap-3">
                                <CheckCircle2 className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#D4AF6A' }} />
            ...
            <div className="max-w-6xl mx-auto px-6 py-16">
                <h2 className="text-3xl font-semibold mb-6" style={{ color: '#F2EFEA' }}>Eligibility & Quality Requirements</h2>
                <p className="mb-8" style={{ color: '#E5E5E5' }}>
                    Placement in Storygate Studio™ is conditional. Projects must satisfy both requirements below.
                </p>

                {/* Rule 1 */}
                <Card className="mb-6" style={{ borderWidth: '2px', borderColor: '#D4AF6A', backgroundColor: 'rgba(14, 14, 14, 0.8)' }}>
                    <CardContent className="p-8">
                        <h3 className="text-2xl font-semibold mb-4" style={{ color: '#F2EFEA' }}>
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-6" style={{ color: '#E5E5E5' }}>
                            <li>Pitch / logline</li>
                            <li>Synopsis</li>
                        ...
                        <p className="italic mb-4" style={{ color: '#B0B0B0' }}>
                ...
                {/* Rule 2 */}
                <Card style={{ borderWidth: '2px', borderColor: '#D4AF6A', backgroundColor: 'rgba(14, 14, 14, 0.8)' }}>
                    <CardContent className="p-8">
                        <h3 className="text-2xl font-semibold mb-4" style={{ color: '#F2EFEA' }}>
                        ...
                        <div className="space-y-4 mb-6">
                            <div className="pl-4" style={{ borderLeftWidth: '4px', borderLeftColor: '#D4AF6A' }}>
                                ...
                                <ul className="list-disc list-inside pl-4 space-y-1" style={{ color: '#E5E5E5' }}>
                        ...
                        <p className="mb-2 font-medium" style={{ color: '#E5E5E5' }}>
                            Equivalent evaluations must include:
                        </p>
                        <ul className="list-disc list-inside space-y-1 mb-6" style={{ color: '#E5E5E5' }}>
            ...
            <div className="py-16" style={{ backgroundColor: 'rgba(14, 14, 14, 0.8)' }}>
                <div className="max-w-6xl mx-auto px-6">
                    <h2 className="text-3xl font-semibold mb-6" style={{ color: '#F2EFEA' }} id="creators">Creator Responsibilities</h2>
                    <p className="mb-4" style={{ color: '#E5E5E5' }}>Creators must:</p>
            ...
            <div className="py-16" style={{ backgroundColor: 'rgba(169, 142, 74, 0.1)' }}>
                <div className="max-w-6xl mx-auto px-6">
                    <h2 className="text-3xl font-semibold mb-6" style={{ color: '#F2EFEA' }}>Governance & Audit Trail</h2>
                    <p className="mb-4" style={{ color: '#E5E5E5' }}>All access is logged. The system records:</p>
                    <ul className="grid md:grid-cols-2 gap-3 mb-6">
                        {[
                            ...
                            <li key={idx} className="flex items-start gap-3">
                                <div className="w-2 h-2 rounded-full flex-shrink-0 mt-2" style={{ backgroundColor: '#D4AF6A' }} />
                                <span style={{ color: '#FFFFFF' }}>{item}</span>
                            </li>
                        ))}
                    </ul>
                    <p className="italic" style={{ color: '#B0B0B0' }}>
            ...
            {/* Footer CTAs */}
            <div className="border-t py-16" style={{ borderColor: '#D4AF6A' }}>
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                        <Card style={{ borderWidth: '2px', borderColor: '#D4AF6A', backgroundColor: 'rgba(14, 14, 14, 0.8)' }} className="overflow-hidden">
                            <CardContent className="p-6 sm:p-8 text-center">
                                <h3 className="text-lg sm:text-xl font-semibold mb-4" style={{ color: '#F2EFEA' }} id="industry">For Industry</h3>
                        ...
                        <Card style={{ borderWidth: '2px', borderColor: '#D4AF6A', backgroundColor: 'rgba(14, 14, 14, 0.8)' }} className="overflow-hidden">
                            <CardContent className="p-6 sm:p-8 text-center">
                                <h3 className="text-lg sm:text-xl font-semibold mb-4" style={{ color: '#F2EFEA' }}>For Creators</h3>
