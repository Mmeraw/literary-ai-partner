...
export default function Synopsis() {
    ...
    const [inputMode, setInputMode] = useState('document'); // 'document' (default)
    ...
    const generateSynopsis = async (type) => {
        if (!selectedManuscriptId) {
            toast.error('Please select a manuscript from your Dashboard');
            return;
        }
                ...
                <Card className="mb-8">
                    ...
                    <CardContent className="space-y-4">
                        <DocumentSelector
                            ...
                            description="All your uploaded manuscripts from the Dashboard"
                        />
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <Button 
                                    ...
                                    disabled={
                                        generating || 
                                        (!selectedManuscriptId || gateState.blocked || (gateState.state === 'G' && !allowAmbiguity))
                                    }
                                    className="w-full"
                                >
                                    {generating ? (
