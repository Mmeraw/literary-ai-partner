                        ...
                        <div className="hidden md:flex items-center gap-1 flex-1">
                            ...
                            {!loading && user && (
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button variant="ghost" className="h-9 px-3 text-sm text-slate-600 hover:text-slate-900">
                                            <span className="text-red-600 font-bold">Storygate Studio™</span> <ChevronDown className="ml-1 h-4 w-4" />
                                        </Button>
                                    </DropdownMenuTrigger>
                                    <DropdownMenuContent align="start" className="w-56">
                                ...
                                <div>
                                    ...
                                    >
                                        <span className="flex items-center">
                                            ...
                                            <span className="text-red-600 font-bold">Storygate Studio™</span>
                                        </span>
